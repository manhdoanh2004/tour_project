    ...
    passWord: Joi.string()
      ...
      phone:Joi.string().required().custom((value,helpers)=>
      {
        if (!/(84|0[3|5|7|8|9])+([0-9]{8})\b/g.test(value)) {
            return helpers.error("phone.wrongFormat");
          }
          ...
          return value;
            ...
            .messages({
                ...
                'phone.wrongFormat':"Vui lòng nhập vào đúng định dạng của số điện thoại"
            })
      ,
      role:Joi.string().allow(''),
      positionCompany:Joi.string().allow(''),
      status:Joi.string().required().messages({
        "string.empty":"Vui lòng nhập vào trạng thái hoạt động!"
      }),
...
module.exports.accountAdminEdit = (req, res, next) => {
